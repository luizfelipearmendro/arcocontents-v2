...
import aboutBg from "/images/team/team2.jpg";
    ...
    <Layout>
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <p className="text-muted-foreground text-sm uppercase tracking-[0.3em] mb-4">Quem somos</p>
      ...
      <Section>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl text-foreground/75 font-display font-bold mb-6 ">
          ...
          <div className="bg-card rounded-2xl p-8 border border-border">
            <blockquote className="text-lg font-display italic text-muted-foreground leading-relaxed mb-6">
      ...
      <Section className="bg-warm-dark">
        <div className="text-center mb-16">
          <p className="text-muted-foreground text-sm uppercase tracking-[0.3em] mb-4">Nosso propósito</p>
